                ...
                <div class="post__main">
                    <?php if ($post['type'] === 'photo'): ?>
                        <div class="post-photo__image-wrapper">
                            <img src="uploads/<?= anti_xss($post['img']) ?>" alt="Фото от пользователя" width="760"
                                 height="396">
                        </div>
                    ...
                    <div class="comments">
                        <a class="comments__button button <?= ($comments_for_id === $post['id']) ? "visually-hidden" : ""; ?>"
                        ...
                        <div class="comments__list-wrapper">
                                    ...
                                    <li class="comments__item user">
                                        <div class="comments__avatar">
                                            <a class="user__avatar-link"
                                               href="profile.php?user_id=<?= $comment['user_id'] ?>&active_tab=posts">
                                        ...
                                        <div class="comments__info">
                                            ...
                                            <p class="comments__text"
                                               style="font-size:16px; color:black;text-align:left;font-weight:normal">
                            ...
                            <?php if ($hidded_comments_count !== null): ?>
                                <a class="comments__more-link"
                                   href="<?= $_SERVER['REQUEST_URI']."&show_comments=all#post-".$post['id'] ?>">
                        ...
                        <form class="comments__form form" method="post">
                            <div class="comments__my-avatar">
                                <img class="comments__picture" width="40px+" src="userpics/<?= $user_data['avatar'] ?>"
                                     alt="Аватар пользователя">
                            </div>
                            <div
                                class="form__input-section <?= (!empty($errors['comment']) ? "form__input-section--error" : "") ?>">
                            <textarea class="comments__textarea form__textarea form__input" name="comment" id="comment"
