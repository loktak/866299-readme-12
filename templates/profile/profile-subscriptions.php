        ...
        <li class="post-mini post-mini--photo post user">
            ...
            <div class="post-mini__user-buttons user__buttons">
                ...
                <a href="subscription.php?user_id=<?= $subsriber['id'] ?>"
                   class="post-mini__user-button user__button 
                   user__button--subscription button button--main 
                    <?= (int)$subsriber['is_subscribed'] === 1 ? 'button--quartz">Отписаться' : '">Подписаться'; ?></a>
                <?php endif ?>
            </div>
            </li>
        <?php endforeach ?>
