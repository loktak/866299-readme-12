                ...
                <div class="post-details__main-block post post--details">
                            ...
                            title="Автор">
                                ...
                                <div class="post__info">
                                    <b class="post__author-name">
                                        Репост: <?= anti_xss($post_info['original_author_name']) ?>
                                    </b>
                                    <?php $original_post_date = new DateTime($post_info['original_date']); ?>
                                    <time class="post__time" 
                                    title="<?= $original_post_date->format('d.m.Y H:i') ?>" 
                                    datetime="<?= $original_post_date->format('Y-m-d H:i:s') ?>">
                                        <?= time_ago($original_post_date) ?>
                                    </time>
                                </div>
                            </a>
                        </div>
                    ...
                    <div class="post__indicators">
                        <div class="post__buttons">
                            ...
                            href="post.php#last-comment" title="Комментарии">
                    ...
                    <div class="comments">
                        <form class="comments__form form" method="post">
                            ...
                            <div class="form__input-section <?= (!empty($errors['comment']) ?
                            "form__input-section--error" : "") ?>">
                                <textarea class="comments__textarea form__textarea form__input" 
                                name="comment" id="comment" placeholder="Ваш комментарий">
                                    <?= getPostValue('comment') ?>
                                </textarea>
                ...
                <div class="post-details__user user">
                    <div class="post-details__user-info user__info">
                        ...
                        <div class="post-details__name-wrapper user__name-wrapper">
                            ...
                            datetime="<?= $user_registration_date->format('Y-m-d H:i:s') ?>">
                            <?= time_ago($user_registration_date, ' на сайте') ?></time>
                        </div>
                    </div>
                    <div class="post-details__rating user__rating">
                        <p class="post-details__rating-item user__rating-item user__rating-item--subscribers">
                            <span class="post-details__rating-amount user__rating-amount">
                                <?= $post_info['subscribers'] ?>
                            </span>
