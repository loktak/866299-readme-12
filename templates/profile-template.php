        ...
        <div class="profile__user user container">
            <div class="profile__user-info user__info">
                ...
                <div class="profile__name-wrapper user__name-wrapper">
                    <span
                        class="profile__name user__name"><?= get_profile_name_with_br(anti_xss($profile_info['login'])) ?></span>
                    ...
                    <time class="profile__user-time user__time"
                          ...
                          datetime="<?= $profile__registration_date->format('Y-m-d H:i:s') ?>"><?= time_ago($profile__registration_date,
                            " на сайте") ?></time>
                </div>
            </div>
            <div class="profile__rating user__rating">
                <p class="profile__rating-item user__rating-item user__rating-item--publications">
                    ...
                    <span class="profile__rating-text user__rating-text"><?= plural_form($profile_info['user_posts'],
                            array('публикация', 'публикации', 'публикаций')) ?></span>
                </p>
                <p class="profile__rating-item user__rating-item user__rating-item--subscribers">
                    <span class="user__rating-amount"><?= $profile_info['user_subs'] ?></span>
                    <span class="profile__rating-text user__rating-text"><?= plural_form($profile_info['user_subs'],
            ...
            <div class="profile__tabs filters">
                ...
                <ul class="profile__tabs-list filters__list tabs__list">
                    <li class="profile__tabs-item filters__item">
                        <a class="profile__tabs-link filters__button tabs__item <?= ($active_tab === 'posts') ? 'filters__button--active tabs__item--active button' : ""; ?>"
                           href="profile.php?active_tab=posts">Посты</a>
                    </li>
                    <li class="profile__tabs-item filters__item">
                        <a class="profile__tabs-link filters__button tabs__item button <?= ($active_tab === 'likes') ? 'filters__button--active tabs__item--active button' : ""; ?>"
                           href="profile.php?active_tab=likes">Лайки</a>
                    </li>
                    <li class="profile__tabs-item filters__item">
                        <a class="profile__tabs-link filters__button tabs__item button <?= ($active_tab === 'subscriptions') ? 'filters__button--active tabs__item--active button' : ""; ?>"
