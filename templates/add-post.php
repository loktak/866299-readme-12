        ...
        <div class="adding-post container">
          <div class="adding-post__tabs-wrapper tabs">
            <div class="adding-post__tabs filters">  
              ...
              <?php foreach ($types as $type) : ?>
                <li class="adding-post__tabs-item filters__item">
                  <a class="adding-post__tabs-link filters__button filters__button--<?= ($type['icon_type']) ?> <?= ($page_parameters['form-type'] === $type['icon_type']) ? 'filters__button--active' : "" ?>" 
                  href = "add.php?type=<?= ($type['icon_type']) ?>">
            ...
            <div class="adding-post__tab-content">
              <section class="adding-post__<?= $page_parameters['form-type'] ?>">
                <h2 class="visually-hidden">Форма добавления <?= $page_parameters['name'] ?></h2>
                <form class="adding-post__form form" action="add.php" method="post" <?= ($page_parameters['form-type'] === 'photo') ? 'enctype="multipart/form-data"' : "" ?>>
