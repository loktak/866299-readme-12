                ...
                <div class="authorization__input-wrapper form__input-wrapper">
                    <div
                        ...
                        <input class="authorization__input authorization__input--login form__input" type="text"
                               name="email" id="email" placeholder="E-mail" value="<?= getPostValue('email') ?>">
                    ...
                    <span
                        class="form__error-label <?= (!empty($errors['email'])) ? "form__input-section--error" : "" ?>"><?= (!empty($errors['email'])) ? $errors['email'] : "" ?></span>
                </div>
                <div class="authorization__input-wrapper form__input-wrapper">
                    <div
                    ...
                    <span
                        class="form__error-label <?= (!empty($errors['password'])) ? "form__input-section--error" : "" ?>"><?= (!empty($errors['password']) ? $errors['password'] : "") ?></span>
                </div>
