    ...
    <section class="feed">
                        ...
                        <header class="post__header post__author">
                            <a class="post__author-link" href="#" title="Автор">
                                ...
                                <div class="post__info">
                                    <b class="post__author-name"><?= $post['author_login'] ?></b>
        ...
        <ul class="feed__filters filters">
            <li class="feed__filters-item filters__item">
                <a class="filters__button <?= ($page_parameters['type'] === 'all') ? "filters__button--active" : "" ?>" href="feed.php?type=all">
                    <span>Все</span>
                </a>
            </li>
            <?php foreach ($types as $type) : ?>
                <li class="feed__filters-item filters__item">
                    <a class="filters__button filters__button--<?= ($type['icon_type']) ?> button <?= ($page_parameters['type'] === $type['icon_type']) ? 'filters__button--active' : "" ?>" href="feed.php?type=<?= $type['icon_type'] ?>">
